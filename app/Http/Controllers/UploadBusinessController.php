...
class UploadBusinessController extends Controller
{
    /**
    ...
    {
        //
        $data = UploadBook::where('kategori', 'Business')->latest()->get();
        return  view('Business.Business', compact('data'));
    }
    ...
    public function store(Request $request)
    {
        ...
        $validatedData['kategori'] = 'Business'; // Tambahkan kategori

        // try{
        //     UploadBook::create($validatedData);
        //     return redirect('/Business')->with("Sukses", "File Terkirim Sukses");
        // }
        // catch(\Exception $e){
        //     return redirect('/Business')->with("Gagal", "File Gagal Terkirim");
        // }
        UploadBook::create($validatedData);
        return redirect('/Business')->with("Sukses", "File Terkirim Sukses");
    }
    ...
    public function show($id)
    {
        ...
        // Kirim data ke view
        return view('Business.show', compact('data', 'fileSize'));
    }
    ...
    public function destroy(string $idbuku)
    {
        ...
        return redirect('/Business')->with('success', 'Data Berhasil Dihapus!');
    }
}
