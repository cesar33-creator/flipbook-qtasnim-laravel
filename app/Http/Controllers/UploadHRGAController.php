...
class UploadHRGAController extends Controller
{
    /**
    ...
    {
        //
        $data = UploadBook::where('kategori', 'HRGA')->latest()->get();
        return  view('HRGA.HRGA', compact('data'));
    }
    ...
    public function store(Request $request)
    {
        ...
        $validatedData['kategori'] = 'HRGA'; // Tambahkan kategori

        // try{
        //     UploadBook::create($validatedData);
        //     return redirect('/HRGA')->with("Sukses", "File Terkirim Sukses");
        // }
        // catch(\Exception $e){
        //     return redirect('/HRGA')->with("Gagal", "File Gagal Terkirim");
        // }
        UploadBook::create($validatedData);
        return redirect('/HRGA')->with("Sukses", "File Terkirim Sukses");
    }
    ...
    public function show($id)
    {
        ...
        // Kirim data ke view
        return view('HRGA.show', compact('data', 'fileSize'));
    }
    ...
    public function destroy(string $idbuku)
    {
        ...
        return redirect('/HRGA')->with('success', 'Data Berhasil Dihapus!');
    }
}
