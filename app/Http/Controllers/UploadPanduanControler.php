...
class UploadPanduanControler extends Controller
{
    /**
    ...
    {
        //
        $data = UploadFile::where('kategori', 'Buku-Panduan')->latest()->get();
        return  view('BukuPanduan.BukuPanduan', compact('data'));
    }
    ...
    {
        //
        return view('BukuPanduan.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        $validatedData['kategori'] = 'Buku-Panduan'; // Tambahkan kategori

        // try{
        //     UploadFile::create($validatedData);
        //     return redirect('/BukuPanduan')->with("Sukses", "File Terkirim Sukses");
        // }
        // catch(\Exception $e){
        //     return redirect('/BukuPanduan')->with("Gagal", "File Gagal Terkirim");
        // }
        UploadFile::create($validatedData);
        return redirect('/BukuPanduan')->with("Sukses", "File Terkirim Sukses");
    }
    ...
    public function show($id)
    {
        ...
        // Kirim data ke view
        return view('BukuPanduan.show', compact('data', 'fileSize'));
    }
    ...
    public function destroy(string $id)
    {
        ...
        return redirect('/BukuPanduan')->with('success', 'Data Berhasil Dihapus!');
    }
}
