...
class UploadHealthcareController extends Controller
{
    /**
    ...
    {
        //
        $data = UploadBook::where('kategori', 'Health')->latest()->get();
        return  view('Healthcare.Healthcare', compact('data'));
    }
    ...
    public function store(Request $request)
    {
        ...
        $validatedData['kategori'] = 'Healthcare'; // Tambahkan kategori

        // try{
        //     UploadBook::create($validatedData);
        //     return redirect('/Healthcare')->with("Sukses", "File Terkirim Sukses");
        // }
        // catch(\Exception $e){
        //     return redirect('/Healthcare')->with("Gagal", "File Gagal Terkirim");
        // }
        UploadBook::create($validatedData);
        return redirect('/Healthcare')->with("Sukses", "File Terkirim Sukses");
    }
    ...
    public function show($id)
    {
        ...
        // Kirim data ke view
        return view('Healthcare.show', compact('data', 'fileSize'));
    }
    ...
    public function destroy(string $idbuku)
    {
        ...
        return redirect('/Healthcare')->with('success', 'Data Berhasil Dihapus!');
    }
}
