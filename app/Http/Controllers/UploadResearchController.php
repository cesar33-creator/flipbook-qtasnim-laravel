...
class UploadResearchController extends Controller
{
    ...
    {
        //
        $data = UploadFile::where('kategori', 'Research')->latest()->get();
        return  view('Research.Research', compact('data'));
    }
    ...
    public function store(Request $request)
    {
        ...
        $validatedData['kategori'] = 'Research'; // Tambahkan kategori

        // try{
        //     UploadFile::create($validatedData);
        //     return redirect('/Research')->with("Sukses", "File Terkirim Sukses");
        // }
        // catch(\Exception $e){
        //     return redirect('/Research')->with("Gagal", "File Gagal Terkirim");
        // }
        UploadFile::create($validatedData);
        return redirect('/Research')->with("Sukses", "File Terkirim Sukses");
    }
    ...
    public function show($id)
    {
        ...
        // Kirim data ke view
        return view('Research.show', compact('data', 'fileSize'));
    }
    ...
    public function destroy(string $idbuku)
    {
        ...
        return redirect('/Research')->with('success', 'Data Berhasil Dihapus!');
    }
}
