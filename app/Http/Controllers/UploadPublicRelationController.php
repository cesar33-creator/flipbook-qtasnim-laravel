...
class UploadPublicRelationController extends Controller
{
    ...
    {
        //
        return view('PublicRelation.create');
    }
    ...
    public function show($id)
    {
        ...
        // Kirim data ke view
        return view('PublicRelation.show', compact('data', 'fileSize'));
    }
    ...
    public function destroy(string $idbuku)
    {
        ...
        return redirect('/PublicRelation')->with('success', 'Data Berhasil Dihapus!');
    }
}
