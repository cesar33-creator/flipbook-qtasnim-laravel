...
class UploadKaryawannControler extends Controller
{
    /**
    ...
    {
        //
        $data = UploadFile::where('kategori', 'Buku-Karyawan')->latest()->get();
        return  view('BukuKaryawan.BukuKaryawan', compact('data'));
    }
    ...
    {
        //
        return view('BukuKaryawan.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        $validatedData['kategori'] = 'Buku-Karyawan'; // Tambahkan kategori

        try {
            UploadFile::create($validatedData);
            return redirect('/BukuKaryawan')->with("Sukses", "File Terkirim Sukses");
        } catch (\Exception $e) {
            return redirect('/BukuKaryawan')->with("Gagal", "File Gagal Terkirim");
        }
    }
    ...
    public function show($id)
    {
        ...
        // Kirim data ke view
        return view('BukuKaryawan.show', compact('data', 'fileSize'));
    }
    ...
    public function destroy(string $id)
    {
        ...
        return redirect('/BukuKaryawan')->with('success', 'Data Berhasil Dihapus!');
    }
}
