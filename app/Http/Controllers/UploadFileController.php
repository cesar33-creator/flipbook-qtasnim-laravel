...
class UploadFileController extends Controller
{
    ...
    {
        //
        $data = UploadFile::where('kategori', 'Buku-Khusus')->latest()->get();
        return  view('BukuKhusus.BukuKhusus', compact('data'));
    }
    ...
    public function store(Request $request)
    {
        ...
        $validatedData['kategori'] = 'Buku-Khusus'; // Tambahkan kategori

        try{
            UploadFile::create($validatedData);
            return redirect('/BukuKhusus')->with("Sukses", "File Terkirim Sukses");
        }catch(\Exception $e){
            return redirect('/BukuKhusus')->with("Gagal", "File Gagal Terkirim");
        }
    }
    ...
    public function show($id)
    {
        ...
        // Kirim data ke view
        return view('BukuKhusus.show', compact('data', 'fileSize'));
    }
    ...
    public function destroy(string $id)
    {
        ...
        return redirect('/BukuKhusus')->with('success', 'Data Berhasil Dihapus!');
    }
}
