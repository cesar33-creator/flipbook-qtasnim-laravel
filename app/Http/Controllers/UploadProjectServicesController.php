...
class UploadProjectServicesController extends Controller
{
    ...
    {
        //
        return view('ProjectServices.create');
    }
    ...
    public function show($id)
    {
        ...
        // Kirim data ke view
        return view('ProjectServices.show', compact('data', 'fileSize'));
    }
    ...
    public function destroy(string $idbuku)
    {
        ...
        return redirect('/ProjectServices')->with('success', 'Data Berhasil Dihapus!');
    }
}
