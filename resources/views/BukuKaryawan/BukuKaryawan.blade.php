...
<head>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            ...
            $('#backButtonKr').on('click', function() {
                window.history.back();
            });
            // Pencarian
            ...
            // Menangani event klik tombol Back
    ...
    <title>Daftar Buku Karyawan</title>
...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-white fixed-top shadow-sm">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <button class="btn btn-outline-danger ml-2 my-2 my-sm-0 back-btn" id="backButtonKr">
    ...
    <!-- H1 Buku Karyawan -->
    <h1 class="text-center mt-8">Daftar Buku Karyawan</h1>
    ...
    <a href="UploadKaryawan/create" class="btn-upload" id="uploadBtn">
