...
<head>
    ...
    <title>Upload Buku Karyawan</title>
...
<body>
    <div class="container">
        ...
        <form action="/UploadKaryawan" method="POST" enctype="multipart/form-data">
            @csrf
