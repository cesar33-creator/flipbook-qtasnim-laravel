...
<body>
    ...
    <h2 class="bookshelf-title">Daftar Buku Pustaka</h2>
    <div class="bookshelf">
        ...
        <a href="UploadPustaka/create" class="btn-upload" id="uploadBtn">
