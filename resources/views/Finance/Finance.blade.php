...
<body>
    ...
    <h2 class="bookshelf-title">Daftar Buku Finance</h2>
    <div class="bookshelf">
        ...
        <a href="UploadFinance/create" class="btn-upload" id="uploadBtn">
