...
<head>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            $("#read").flipBook({
            //Layout Setting
            pdfUrl: "{{ asset ('assets/pdf/20200130_Draft_Kode_Etik_Qtasnim_v5_(1).pdf') }}",
            lightBox:true,
            layout:3,
            ...
            sideBtnRadius:60,
            btnBookmark: { enabled: false }, // Pastikan ini ditambahkan
    ...
    <section class="info" id="info">
        <div class="container">
            <div class="card shadow">
                <div class="row">
                    <div class="col-md-3">
                        <img src="{{ asset('assets/book2/KodeEtikQtasnim.jpg') }}" class="w-100 book-1">
                    </div>
                    <div class="col-md-7 mt-3">
                        <!-- Info -->
                        <h3 id="title">Kode Etik Qtasnim</h3>
                        <p id="size"><i class="fas fa-file "></i> File Size <b>857KB</b></p>
                        <!-- Button -->
                        <div class="button">
                            <a id="read" class="btn btn-primary mt-2 text-white">Baca PDF <i class="fas fa-book-reader fa-lg"></i></a>
                            <a href="{{ asset('assets/pdf/20200130_Draft_Kode_Etik_Qtasnim_v5_(1).pdf') }}" class="btn btn-primary mt-2 text-white" download>Unduh PDF <i class="fas fa-download fa-lg"></i></a>
                        </div>
                        <!-- Description -->
