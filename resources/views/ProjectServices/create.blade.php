...
<head>
    ...
    <title>Upload Buku Project & Services </title>
...
<body>
    <div class="container">
        <h1>Upload Buku Project & Services</h1>
        ...
        <form action="/UploadProjectServices" method="POST" enctype="multipart/form-data">
            @csrf
            ...
            <a href="/ProjectServices">Kembali</a>
        </form>
    </div>
</body>
</html>