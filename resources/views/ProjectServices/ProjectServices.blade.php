...
window.onload = function () {
    ...
    function addBook(newBookData) {
        ...
        newBook.innerHTML = `
            <a href="/ProjectServices/${newBookData.id}">
...
<body>
    ...
    <h2 class="bookshelf-title">Daftar Buku Project & Services</h2>
    <div class="bookshelf">
            ...
            <div class="shelf has-books" id="shelf1">
                ...
                <div class="covers" id="coversContainer">
                    ...
                    <div class="thumb book-3" data-name="{{ $item->nama_buku }}" data-id="{{ $item->idbuku }}" data-image="{{ asset('storage/' . $item->image_buku) }}">
                        <a href="/ProjectServices/{{ $item->idbuku }}">
        ...
        <a href="UploadProjectServices/create" class="btn-upload" id="uploadBtn">
