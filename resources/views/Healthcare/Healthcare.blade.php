...
window.onload = function () {
    ...
    function addBook(newBookData) {
        ...
        newBook.innerHTML = `
            <a href="/Healthcare/${newBookData.id}">
...
<body>
    ...
    <h2 class="bookshelf-title">Daftar Buku Health Care Solution</h2>
    <div class="bookshelf">
        ...
        <a href="UploadHealthcare/create" class="btn-upload" id="uploadBtn">
