...
<head>
    ...
    <title>Upload Buku Health Care Solution </title>
...
<body>
    <div class="container">
        <h1>Upload Buku Health Care Solution</h1>
        ...
        <form action="/UploadHealthcare" method="POST" enctype="multipart/form-data">
            @csrf
