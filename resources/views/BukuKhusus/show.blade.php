...
<head>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            //Alert Delete
            document.getElementById('btnDeleteKh').addEventListener('click', function(e) {
...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-white fixed-top shadow-sm">
        ...
        <div class="ml-auto d-flex align-items-center">
            ...
            <!-- Button Delete -->
            <form action="/UploadFile/{{ $data->id }}" method="post" id="deleteForm" class="p-0 m-0">
                @csrf
                @method('delete')
                <button type="button" class="btn btn-outline-danger" id="btnDeleteKh">
