...
window.onload = function () {
    ...
    function addBook(newBookData) {
        ...
        newBook.innerHTML = `
            <a href="/Business/${newBookData.id}">
...
<body>
    ...
    <h2 class="bookshelf-title">Daftar Buku Business Development</h2>
    <div class="bookshelf">
        ...
        <a href="UploadBusiness/create" class="btn-upload" id="uploadBtn">
