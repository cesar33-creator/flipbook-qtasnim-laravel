...
<head>
    ...
    <title>Upload Buku Public Relation & Partnership </title>
...
<body>
    <div class="container">
        <h1>Upload Buku Public Relation & Partnership</h1>
        ...
        <form action="/UploadPublicRelation" method="POST" enctype="multipart/form-data">
            @csrf
            ...
            <a href="/PublicRelation">Kembali</a>
        </form>
    </div>
</body>
</html>